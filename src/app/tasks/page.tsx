...
export default function TasksPage(): JSX.Element {
  ...
  const TaskCard: React.FC<{ task: TaskType; onEdit: (task: TaskType) => void }> = ({
    task,
    onEdit
  }) => (
      ...
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between">
          <div className="flex-1 pr-8">
            <CardTitle className="text-white text-base font-semibold mb-1.5 group-hover:text-blue-300 transition-colors">
              {task.title}
            </CardTitle>
    ...
    <div className="p-6 md:p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between">
          ...
          <Button className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white shadow-lg shadow-blue-500/30 glow-effect">
