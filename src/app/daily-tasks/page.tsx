...
// ✅ Mock fallback
const mockUser: User = { id: "u1", full_name: "Alice Johnson", role: "team_leader" };
const mockTasks: Task[] = [
  {
    id: "t1",
    user_id: "u1",
    task: "Prepare dashboard",
    expected_outcome: "Design main dashboard",
    category: "UI",
  ...
  },
  {
    ...
    expected_outcome: "Connect analytics endpoints",
    category: "Backend",
    task_status: "Pending",
    priority: "Critical",
    date: "2025-08-22",
...
const mockTeamMembers: User[] = [
  { id: "u2", full_name: "Bob Smith", role: "member" },
  { id: "u3", full_name: "Carol White", role: "member" },
];
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-slate-400">
              Comprehensive overview of project tasks and team performance
            </p>
          </div>
        ...
        <Tabs defaultValue="tasks" className="w-full">
          <TabsList className="bg-slate-800/50 border border-slate-700/40 p-1 rounded-xl mb-6">
            <TabsTrigger
              value="tasks"
              className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-purple-600 data-[state=active]:text-white text-slate-300"
            >
